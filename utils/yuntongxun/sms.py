...
_accountSid = '8aaf0708721773ab0172232c014101f1'    # '开发者主账号中的ACCOUNT SID'

# 说明：主账号Token，登陆云通讯网站后，可在控制台-应用中看到开发者主账号AUTH TOKEN
_accountToken = '136ef91ca8a240ce8d47468291d62550'  # ''开发者主账号中的AUTH TOKEN'

# 请使用管理控制台首页的APPID或自己创建应用的APPID
#_appId = '开发者主账号中的AppID(默认)'
_appId = '8aaf0708721773ab0172232c01a401f7'
...
if __name__ == '__main__':
    ...
    result = None
    while True:
        result = ccp.send_template_sms('15897561440', ['6666', 5], "1")
        if result == 0:
            print('短信验证码发送成功！')
            break
